...
class DecayLR(Callback):
    def on_train_batch_start(self, trainer, pl_module, batch, batch_idx):
        ...
        t = cos_anneal(0, 80, 1e-4, 2e-5, trainer.current_epoch)
...
class DecayTemperature(Callback):
    def on_train_batch_start(self, trainer, pl_module, batch, batch_idx):
        ...
        t = cos_anneal(0, 60, 1.0, 1.0 / 16, trainer.current_epoch)
...
if __name__ == "__main__":
    ...
    try:
        ...
        trainer_config['limit_val_batches'] = 0.5
        ...
        common_callbacks = [instantiate_from_config(modelckpt_cfg)] + [instantiate_from_config(callbacks_cfg[k]) for k
                                                                       in callbacks_cfg]
        ...
        trainer_kwargs['strategy'] = DDPStrategy(find_unused_parameters=True, process_group_backend='gloo')
        ...
        # model.init_from_ckpt('tf-logs/2023-04-19T15-55-49_mvtec_trans/check_points/last.ckpt')
